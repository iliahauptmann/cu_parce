...
async def update_data(): # Асинхронно обновляет данные о количестве абитуриентов.
    ...
    cached_data = { # Обновляем кэшированные данные
        "mkn_platka": len(results["02.03.01 Математика и компьютерные науки, Очная, По договору об оказании платных образовательных услуг"]),
        "bi_platka": len(results["38.03.05 Бизнес-информатика, Очная, По договору об оказании платных образовательных услуг"]),
...
Последнее обновление данных: {last_update_time}'''
            ...
            bot.send_message(message.chat.id, "<b>Статистика количества абитуриентов, подавших документы\n</b> 24.06.2024 - 63 человека\n 27.06.2024 - 88 человек\n 29.06.2024 - 116 человек\n 01.07.2024 - 158 человек\n 02.07.2024 - 192 человека",  parse_mode='html') # Обновляется вручную
